...
prediction.Data$action_type = as.character(prediction.Data$action_type)
prediction.Data = prediction.Data %>% 
  ...
  mutate(action_type = if_else(action_type == "Putback Slam Dunk Shot",'Slam Dunk Shot',action_type)) %>%
  mutate(action_type = if_else(action_type == "Running Slam Dunk Shot",'Slam Dunk Shot',action_type))         
prediction.Data$action_type = as.factor(prediction.Data$action_type)
...
prediction.Data$prob = predict(mod_fit, newdata=prediction.Data)
