...
library(pacman)
p_load(rrcov, MASS, dplyr, purrr, ggplot2, Hmisc, jtools, knitr, kableExtra) #( Hmisc is for correlation matrix rcorr() )
...
# Multicollinearity Among Predictor Variables pt. 1
...
# Multicollinearity Among Predictor Variables pt. 2
##Correlation Matrix
...
correlation.matrix <- rcorr(as.matrix(df.numeric), type="pearson")
