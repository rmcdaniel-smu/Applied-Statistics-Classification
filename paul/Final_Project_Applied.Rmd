...
## **Correlation Heat Map for Visual Data Exploration**
...
### Immediately preceeding model development, modeling data is broken into a 75% training / 25% testing data split for internal cross-cross validation. The objective of internal cross-validation is to develop a model using 75% of the data and test it on the remaining 25% in order to assess model fit statistics. Typically, following internal cross-validation, external cross-validation is performed.
...
### Cross-Validation Confusion Matrices for Quadratic Discriminant Analysis
kable(lr.confusionFrame, format="latex", booktabs = T)  %>%
  kable_styling(latex_options="striped", position = "center")
