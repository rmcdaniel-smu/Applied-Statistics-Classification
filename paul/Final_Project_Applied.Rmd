...
colnames(confusionFrame.internal) <- "Internal CV Statistics: Quadratic Discriminant Analytis"
...
colnames(confusionFrame.external) <- "External CV Statistics: Quadratic Discriminant Analytis"
...
training$shot_made_flag <- as.integer(training$shot_made_flag)

training$shot_made_flag <- ifelse(training$shot_made_flag == 1, "made", "not_made")

suppressWarnings(mod_fit <- train(shot_made_flag ~ recId + action_type + game_event_id + 
    loc_x + loc_y + minutes_remaining + playoffs + season + seconds_remaining + 
    shot_type + shot_zone_basic + shot_zone_range + game_date + 
...
unique(training$shot_made_flag)

#training$shot_made_flag <- ifelse(training$shot_made_flag == "made", 1, 0)
