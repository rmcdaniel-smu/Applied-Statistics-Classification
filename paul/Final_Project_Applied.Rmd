...
### Additionally, `action_type` was recoded where shots types were categorized into `short` and `not_short`. However, modeling performance decreased because the parameter became less descriptive.
...
## **Correlation Plot for Visual Data Exploration**
...
kable(list(confusionFrame.internal, confusionFrame.external), format="latex", booktabs = T)
...
```{r Source Code, echo=T, warnings=F}